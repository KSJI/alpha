...
export default class DisplayResult2 extends React.Component {
    constructor(props) {
        super(props);
        // this.state = {
        //     meal: "",
        ...
        //     data: [],
        //     urls: "",
        //     //"https://firebasestorage.googleapis.com/v0/b/alpha-153de.appspot.com/o/images%2FDeleting%20a%20New%20Post.png?alt=media&token=ecc366b8-fe92-4a5b-815d-02b335bafd9c",
        //     fbError: ""
        // };
        this.state = {
    ...
    componentDidMount() {
        ...
        // })
        if (this.props.hello == "hello") {
            this.setState({
                imgUrl: this.props.hello
            }) 
        }
